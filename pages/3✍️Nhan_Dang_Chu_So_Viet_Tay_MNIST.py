...
st.set_page_config(
    page_title="Nhận dạng chữ số viết tay MNIST",
    page_icon="✍️",
)
...
if 'is_load' not in st.session_state:
    # load model
    model_architecture = 'utility/B3_RecognitionDigitMNIST/digit_config.json'
    model_weights = 'utility/B3_RecognitionDigitMNIST/digit_weight.h5'
