import cv2
import numpy as np
import utility.B4_DigitalImageProcessing.Chapter03 as Chapter03
import utility.B4_DigitalImageProcessing.Chapter04 as Chapter04
import utility.B4_DigitalImageProcessing.Chapter05 as Chapter05
import utility.B4_DigitalImageProcessing.Chapter09 as Chapter09
...
with col2:
    ...
    if uploaded_file is not None:
        ...
        image_path = 'utility/B4_DigitalImageProcessing/input/' + uploaded_file.name
        temp_image.save(image_path)
        image = Image.open(image_path)
        st.image(image, caption='Input', use_column_width=True)
        img_array = np.array(image)
        cv2.imwrite('utility/B4_DigitalImageProcessing/out.jpg', cv2.cvtColor(img_array, cv2.IMREAD_GRAYSCALE))
        imgin = cv2.imread('utility/B4_DigitalImageProcessing/out.jpg', cv2.IMREAD_GRAYSCALE)
    else:
        image_path = 'utility/B4_DigitalImageProcessing/data/background.jpg'
        image = Image.open(image_path)
...
with col2:
    if option == "None":
        ...
        cv2.imwrite('utility/B4_DigitalImageProcessing/out.jpg', cv2.cvtColor(imgout, cv2.IMREAD_GRAYSCALE))
